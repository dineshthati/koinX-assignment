...
const Navbar = () => {
  ...
  return (
    <div className="w-full  bg-white flex items-center justify-between py-1 px-5 ">
      <div className="left sm:ml-10">
        <img
      ...
      <div className="right flex ">
        ...
        <div className="sm:flex gap-10  hidden mr-5 items-center">
          {navheaders.map((item, index) => {
            return (
              <p
                className="sm:font-semibold capitalize text-[20px] cursor-pointer tracking-tight  font-medium "
                key={index}
              >
                {item}
              </p>
